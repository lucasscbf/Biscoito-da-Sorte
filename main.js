...
let randomPhraseLuck = document.querySelector("#randomPhraseLuck")
let generateRandomPhraseLuck
...
function handleTryClick(event) {
    ...
    generateRandomPhraseLuck = Math.floor(Math.random()*(phrasesLuck.length));
    randomPhraseLuck.innerText = phrasesLuck[generateRandomPhraseLuck]
      }
